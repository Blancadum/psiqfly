...
subcategory: "bipolares"
category: "trastornos mentales"
breadcrumb: "Trastorno Bipolar"
emoji: "📈"
excerpt: "Guía clínica operativa para el Trastorno Bipolar. Aprende a diferenciar episodios de manía e hipomanía y realizar un diagnóstico diferencial preciso."
readTime: "9 min"
...
keyPoints:
  - "La ciclotimia se define por al menos 2 años de síntomas hipomaníacos y depresivos sub-umbral."
  - "El diagnóstico exige que los síntomas estén presentes al menos la mitad del tiempo."
  - "Diferenciarás la ciclotimia del TLP mediante la autonomía de los ciclos frente a la reactividad interpersonal."

noteBoxes:
  - afterH2: "La inestabilidad como estado basal"
    emoji: "⚖️"
    content: "En la ciclotimia, el paciente no experimenta 'crisis' explosivas, sino que vive en una montaña rusa de baja intensidad. A menudo, esto se confunde con rasgos de personalidad o 'temperamento difícil', retrasando la intervención."
...
references:
  ...
  - "Akiskal, H. S., et al. (2000). *The soft bipolar spectrum*."
---

## Clasificación de los trastornos bipolares

### 1. Trastorno Bipolar I (296.xx / F31)
...
### 2. Trastorno Bipolar II (296.89 / F31.81)
...
## La ciclotimia: El espectro persistente
...
1. **Síntomas Hipomaníacos:** Periodos frecuentes que no alcanzan los criterios de un episodio hipomaníaco completo.
2. **Síntomas Depresivos:** Periodos frecuentes que no alcanzan los criterios de un episodio depresivo mayor.
3. **Persistencia:** Los síntomas están presentes al menos la mitad del tiempo y nunca desaparecen por más de **2 meses seguidos**.
4. **Exclusión de Episodios Mayores:** Nunca se han cumplido criterios de Manía, Hipomanía o Depresión Mayor en el pasado.

## Diferencial: ¿Personalidad o Ánimo?

El reto para el profesional es no confundir la ciclotimia con el **Trastorno Límite de la Personalidad (TLP)**. En la ciclotimia, los cambios de ánimo suelen ser más "autónomos" y rítmicos, mientras que en el TLP son respuestas explosivas a estresores interpersonales.
[TLP](/trastornos-mentales/personalidad/tlp).
